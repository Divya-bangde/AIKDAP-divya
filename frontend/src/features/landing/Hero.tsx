    ...
    >
      <div className="flex max-w-2xl flex-col items-start">
        ...
        <motion.div variants={landingItem} className="mt-12 flex flex-wrap items-center gap-4">
          <Link
            to="/login"
            className="press group inline-flex items-center gap-3 rounded-xl bg-foreground px-7 py-4 font-display text-base font-medium tracking-tight text-background shadow-float hover:bg-primary hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Enter AIKDAP
            <ArrowRight
              aria-hidden="true"
          ...
          <a
            href="#pipeline"
            className="press group inline-flex items-center gap-2 rounded-xl border border-border-strong px-6 py-4 font-display text-base font-medium tracking-tight text-foreground hover:border-primary hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
